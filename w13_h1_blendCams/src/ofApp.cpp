...
//    img.load("imgClient.jpg");
    ...
    // choose Logitech external camera
...
void ofApp::draw(){
    ...
    vidExt.draw(0,0);    // draw captured webcam frame
    
    
    
    ofEnableBlendMode(blendmode);            // SET TO CUSTOM BLENDMODE
    
    fbo.draw(0,0);    // draw current webcam frame on top, with alpha blending
